  ...
  <div class="toolbar-container">
    ...
    <div class="toolbar-main">
      <div class="left-toolbar">
        <el-button v-if="showToolButton('showAdvanceAndRetreat')" link type="primary" :disabled="undoDisabled" :title="i18nt('designer.toolbar.undoHint')" @click="undoHistory">
        ...
        <el-button link type="primary" :disabled="redoDisabled" :title="i18nt('designer.toolbar.redoHint')" @click="redoHistory">
          <svg-icon v-if="showToolButton('showAdvanceAndRetreat')" icon-class="redo" /></el-button>
          <!--  -->
        <el-button-group v-if="showToolButton('showMultimedia')" style="margin-left: 20px">
        ...
        <el-button style="margin-left: 20px" v-if="showToolButton('showStructureTree')" :title="i18nt('designer.toolbar.nodeTreeHint')" @click="showNodeTreeDrawer">
